...
variable "root_domain" {
  default = ""
  description = "Root Domain for ECS Service DNS Record"
}
...
variable "tg_http_port" {
  default = ""
  description = "HTTP Port where the service target group will listen"
}
...
variable "cluster" {
  default = ""
  description = "ECS Cluster to Create the Service into"
}
